...
<div class="container">
    ...
    <section class="section-ewm">
        <div class="left">
            <span class="text">长按识别二维码<br>开启超能力测试 </span>
        </div>
        <div class="right">
...
.container{ background: #f2f7ff url(../assets/images/bg9.jpg) no-repeat center 0; background-size: 100%; }
.section-logo{ 
    padding: 30px 0 0;
...
export default {
    ...
    methods: {
        link(){
            this.$router.push({name: 'problem2'});
        },
        onShowShare(){
